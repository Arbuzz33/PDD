...
- **diskinfo** - prints info about all disks with their partitions (also lets you mount them to get more info)
...
- **format** - formats the disks (at this moment only partition table). Ex: "format -sdc" - lets you create new partition table on sdc (uses fdisk)
